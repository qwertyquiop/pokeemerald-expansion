...
enum {
    ...
    HEAL_LOCATION_HOME_TOWN,
    HEAL_LOCATION_NPCHOUSE,
    HEAL_LOCATION_SLATEPORT_CITY_MART,
    HEAL_LOCATION_SLATEPORT_CITY_POKEMON_CENTER_1F,
    HEAL_LOCATION_ROUTE2,
    HEAL_LOCATION_NANDTA_TOWN,
    HEAL_LOCATION_SUNSET_CITY,
    NUM_HEAL_LOCATIONS
};
