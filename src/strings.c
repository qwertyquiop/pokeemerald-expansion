...
const u8 gText_AlolaGuess[] = ("Alola");
const u8 gText_IDontKnow[] = ("I don't know");
const u8 gText_AlolaPopplio[] = ("Popplio");
const u8 gText_AlolaRowlet[] = ("Rowlet");
const u8 gText_AlolaLitten[] = ("Litten");
