...
static const struct LevelUpMove sAxewALevelUpLearnset[] = {
...
static const struct LevelUpMove sFraxureALevelUpLearnset[] = {
...
static const struct LevelUpMove sHaxorusALevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_THUNDERSHOCK),
    LEVEL_UP_MOVE( 1, MOVE_DRAGON_RAGE),
    LEVEL_UP_MOVE(39, MOVE_DRAGON_BREATH),
    LEVEL_UP_MOVE(42, MOVE_THUNDERBOLT),
