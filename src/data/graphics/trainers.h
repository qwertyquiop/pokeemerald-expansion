...
const u32 gTrainerFrontPic_Lyrica[] = INCBIN_U32("graphics/trainers/front_pics/gym1leader.4bpp.lz");
const u16 gTrainerPalette_Lyrica[] = INCBIN_U16("graphics/trainers/front_pics/gym1leader.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_LYRICA, gTrainerFrontPic_Lyrica, gTrainerPalette_Lyrica),
};
